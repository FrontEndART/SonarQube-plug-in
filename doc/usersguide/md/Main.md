...
- Java: `sourcemeter-analyzer-java-plugin-2.1.0.jar`
- JavaScript: `sourcemeter-analyzer-javascript-plugin-2.1.0.jar`
- Python: `sourcemeter-analyzer-python-plugin-2.1.0.jar`
- RPG: `sourcemeter-analyzer-rpg-plugin-2.1.0.jar`
